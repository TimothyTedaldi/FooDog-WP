 ...
 */
class NP_Social_Share_Counter_Loader {
    ...
    public static function sanitize_array($array = array(), $sanitize_rule = array()) {
        ...
        foreach ($array as $k => $v) {
            ...
            if (!is_array($v)) {
                ...
                $array[$k] = NP_Social_Share_Counter_Loader::sanitize_value($v, $sanitize_type);
            }
            if (is_array($v)) {
                $array[$k] = NP_Social_Share_Counter_Loader::sanitize_array($v, $sanitize_rule);
            }
        }
